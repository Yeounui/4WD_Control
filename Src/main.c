...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOA, VL53_XSHUT_FRONT_Pin|VL53_XSHUT_LEFT_Pin|VL53_XSHUT_RIGHT_Pin|MOTOR_LR_FWD_Pin
                          |MOTOR_LF_REV_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOB, MOTOR_LR_REV_Pin|MOTOR_LF_FWD_Pin|MOTOR_RF_FWD_Pin|MOTOR_RF_REV_Pin
                          |MOTOR_RR_FWD_Pin|MOTOR_RR_REV_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = VL53_XSHUT_FRONT_Pin|VL53_XSHUT_LEFT_Pin|VL53_XSHUT_RIGHT_Pin|MOTOR_LR_FWD_Pin
                          |MOTOR_LF_REV_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  ...
  /**/
  GPIO_InitStruct.Pin = MOTOR_LR_REV_Pin|MOTOR_LF_FWD_Pin|MOTOR_RF_FWD_Pin|MOTOR_RF_REV_Pin
                          |MOTOR_RR_FWD_Pin|MOTOR_RR_REV_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
